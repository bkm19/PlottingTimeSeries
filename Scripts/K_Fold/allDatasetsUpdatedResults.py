...
csv_name = '20_violinplots_box_results.csv'
...
for name in DATA_SET_NAMES:
  ...
  plots = "Violinplots_box"
  #plots = "Boxplots"

  ############## With No Fliers ##############
  #pathName = '/PATH_CHANGE/' + str(numberOfPlots) + '_' + plots.lower() + '_no_fliers' + '/'
  #pathHistory = '/PATH_CHANGE/' + str(numberOfPlots) + '_' + plots.lower() + '_no_fliers' + '/' + name + '.csv'

  pathName = '/PATH_CHANGE/' + str(numberOfPlots) + '_' + plots.lower() + '/'
  pathHistory = '/PATH_CHANGE/' + str(numberOfPlots) + '_' + plots.lower() + '_' + name + '_history/'
  ...
  for train_idx, val_idx in list(kfold.split(train_x, train_y)):
      ...
      modelPath = "/PATH_CHANGE/saved_models/" + str(numberOfPlots) + '_' + plots.lower() + '_' + name + '_fold' + str(fold_no) + '_model.h5'
